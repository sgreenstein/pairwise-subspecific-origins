...
//    .style("opacity", 1e-6);
  ...
  var pixel_mouseover = function(d){
      d3.select(tick_row[0][d.i]).attr("fill", "grey");
      d3.select(tick_col[0][d.j]).attr("fill", "grey");
  ...
  var mouseout = function(d){
      d3.select(tick_row[0][d.i]).attr("fill", "black");
      d3.select(tick_col[0][d.j]).attr("fill", "black");
  };
